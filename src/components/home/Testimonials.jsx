...
const TestimonialCard = ({ img, alt, text, name, title }) => (
    <div className='w-[250px] h-[250px] p-4 bg-white/30 backdrop-blur-md rounded-lg flex justify-center items-center flex-col text-center md:w-[300px] md:h-[300px]'>
...
export default function Testimonials() {
    const settings = {
        ...
        autoplay: true,
        autoplaySpeed: 2000,
        arrows: false, // Ajout de cette ligne pour retirer les flèches
        responsive: [
            {
