...
function HeroSection() {
  return (
    <div className="h-[calc(100vh-128px)] bg-gradient-to-b from-transparent to-[#F39593] from-80%">
      ...
      <div className="bg-cover bg-center h-full flex items-center justify-center">
        <div className="flex flex-col-reverse lg:flex-row justify-center w-full items-center px-4 lg:px-40">
          <div className="w-full lg:w-[1300px] lg:mb-0 flex justify-center items-center flex-col gap-5">
            ...
            <Link
              to="/services"
              className="font-[poppins] bg-black text-bold text-[#ffffff] transition-all hover:text-[#ffffff] hover:scale-105 py-2 px-1 font-medium sm:text-lg lg:text-xl text-center flex justify-center items-center w-60 rounded-md"
            >
              Découvrir
            </Link>
          </div>
