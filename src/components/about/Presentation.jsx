  ...
  return (
    ...
    >
      ...
      <p className='text-lg max-w-[600px] mx-auto'>
          Je suis un développeur passionné, spécialisé dans la création de sites web et d'applications modernes. Avec une expertise en React, Tailwind, et bien plus encore, je propose des solutions sur mesure pour répondre à vos besoins.
        </p>
      </div>
    </motion.div>
  );
